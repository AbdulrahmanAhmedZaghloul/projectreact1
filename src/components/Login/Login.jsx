...
<div className="flex w-full items-center">
                            ...
                            {/* <div className="relative z-0  mx-auto py-7 group">
                                ...
                                <label
                                    htmlFor="password"
                                    className="peer-focus: absolute text-lg top-0 text-gray-500 :text-gray-400 duration-300 scale-75 last: -z-10 origin-[0] left-0 peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text--600 peer-focus::text--500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                                >
                                    Password:
                                </label>
                                {formik.errors.password && formik.touched.password ? (
